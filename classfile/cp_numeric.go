...
// ConstantIntegerInfo : CONSTANT_Integer_info使用4字节存储整数常量，其结构定义如下：
/*
...
// ConstantFloatInfo : CONSTANT_Float_info使用4字节存储IEEE754单精度浮点数常量，结构如下：
/*
CONSTANT_Float_info {
    u1 tag;
    u4 bytes;
...
// ConstantLongInfo : CONSTANT_Long_info使用8字节存储整数常量，结构如下：
/*
CONSTANT_Long_info {
    u1 tag;
    u4 high_bytes;
...
// ConstantDoubleInfo : CONSTANT_Double_info使用8字节存储IEEE754双精度浮点数，结构如下：
/*
